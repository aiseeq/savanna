...
const (
	...
	GrassPerEatingTick   = 2.0  // Трава съедаемая за кадр анимации (увеличено для быстрого восстановления)
	GrassNutritionValue  = 3.0  // Сколько сытости дает 1 единица травы (увеличено для быстрого восстановления)
	...
	CorpseNutritionPerTick = 5.0 // Питательность съедаемая за кадр анимации - увеличено для быстрого поедания
...
const (
	...
	// Скорость анимации атаки (кадров в секунду)
	AttackAnimationFPS = 6.0 // Скорость анимации атаки (из loader.go)
)
